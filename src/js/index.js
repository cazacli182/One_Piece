...
//Pega a div que contém a classe .personagem e guarda em uma var.
...
botoes.forEach((botao, indice) => {
    botao.addEventListener("click", () => {
        ...
        desselecionarBotao();
        desselecionarPersonagem();//remove a classe "selecionado" injetada no html, ai aparece certinho o que fizer abaixo!
        ...
        //**********************************************************************************************************
        //O índice passado no parâmetro é para poder saber qual botão foi clicado e mudar a imagem do personagem.
        personagens[indice].classList.add("selecionado"); //injeto o selecionado para que o css trate e posiciona na imagem!
    });
});
